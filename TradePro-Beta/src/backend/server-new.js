...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ? [
        'https://tradepro-beta.onrender.com',
        'https://tradepro-beta-production.onrender.com',
        process.env.FRONTEND_URL || 'https://tradepro-beta.onrender.com'
      ] 
...
// Database setup - Render.com için geçici dosya sistemi
const dbPath = process.env.NODE_ENV === 'production' 
  ? '/tmp/tradepro.db'  // Render.com'da geçici dizin
  : path.join(__dirname, 'database/tradepro.db');
